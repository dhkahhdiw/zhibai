...
async def load_symbol_filters():
    ...
    price_step = float(pf['tickSize']); qty_step = float(ls['stepSize'])
...
async def ensure_session():
    ...
    if session is None or session.closed:
        LOG.warning("Recreating aiohttp session")
